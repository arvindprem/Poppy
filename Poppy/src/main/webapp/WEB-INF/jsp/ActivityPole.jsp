	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="modalbox">
					<form id="editActivityPoleForm">
						<div class="row modalheader">
							<div class="col-md-8 col-md-6 col-6">
								<span><i class="fa fa-edit"></i> Edit ActivityPoleInfo</span>
							</div>
...
<div class="row spaceBetweenLines">
	<div class="col-md-6 col-sm-12 col-12">
		<div class="form-group">
			<label for="ActivityPoleLabel">Label <span class="asterik">*</span>
			</label> <input type="text" class="form-control" name="ActivityPoleLabel"
				id="ActivityPoleLabel"> <input type="hidden" name="id"
				id="id">
		</div>
	</div>
</div>
