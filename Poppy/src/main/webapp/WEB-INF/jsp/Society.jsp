	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="modalbox">
					<form id="editSocietyForm">
						<div class="row modalheader">
							<div class="col-md-8 col-md-6 col-6">
								<span><i class="fa fa-edit"></i> Edit Society Info</span>
							</div>
							<div class="col-md-4 col-sm-6 col-6 text-right">
								<button
									class="mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab"
									data-toggle="tooltip" title="Save Society">
						...
						<div class="row spaceBetweenLines">
							<div class="col-md-6 col-sm-12 col-12">
								<div class="form-group">
									<label for="SocietyLabel">Label <span class="asterik">*</span>
									</label> <input type="text" class="form-control" name="SocietyLabel"
										id="SocietyLabel"> <input type="hidden" name="id"
										id="id">
								</div>
							</div>
						</div>
						...
						<div class="col-md-6 col-sm-12 col-12">
							...
							<div class="col-md-6 col-sm-12 col-12">
								<div class="form-group">
									<label for="userName">Responsible Name <span
										class="asterik">*</span>
							...
							<div class="form-group">
								<label for="firstName">Responsible Email <span
									class="asterik">*</span>
