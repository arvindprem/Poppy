	...
	<section class="login-content">
		...
		<div class="login-box">
			<form class="login-form" action="VaildateUser" method="Post"
				id="loginForm">
				<div class="form-group">
					<label class=" black">USERNAME</label> <input class="form-control"
						type="text" name="userName" id="userName" placeholder="UserName"
						autofocus>
				</div>
				<div class="form-group">
					<label class=" black">EMAIL</label> <input class="form-control"
						type="text" name="email" id="email" placeholder="Email" autofocus>
				</div>

				<div class="form-group">
					<label class="black">PASSWORD</label> <input class="form-control"
						type="password" name="watchWord" id="watchWord"
			...
			<form class="forget-form">
				...
				<div class="form-group">
					<label class="">OTP</label> <input class="form-control" type="text"
						placeholder="OTP">
				</div>
				<div class="form-group btn-container">
