...
<div class="app-content">
	<div class="card">
		<div class="card-body ">
			<form id="addPoppyVersionForm">
				<div class="card-title">
					<div class="row  headerStyle">
						<div class="col-md-8 col-md-6 col-6">
							<span><i class="fa fa-user"></i> AddPoppyVersion</span>
						</div>
						<div class="col-md-4 col-sm-6 col-6 text-right">
							<button
								class="mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab"
								type="submit" data-toggle="tooltip" title="Save Poppy Version">
...
<script src="js/customjs/addpoppyversion.js"></script>