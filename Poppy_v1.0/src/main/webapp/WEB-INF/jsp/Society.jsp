					...
					<form id="editForm">
						...
						<div class="row spaceBetweenLines">
							<div class="col-md-6 col-sm-12 col-12">
								<div class="form-group">
									<label for="userName">Society Name <span class="asterik">*</span>
							...
							<div class="col-md-6 col-sm-12 col-12">
								<div class="form-group">
									<label for="responsibleEmail">Resposible Email <span
										class="asterik">*</span>
									</label> <input type="email" class="form-control" name="responsibleEmail"
										id="responsibleEmail">
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-12">
								<div class="form-group">
									<label for="GroupLabel">Group Name <span
										class="asterik">*</span>
